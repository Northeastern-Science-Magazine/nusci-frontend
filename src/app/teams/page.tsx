...
export default function TeamsPage() {
    const teams: { [team: string] : TeamMemberProps[]; } = {
        writing: [
            {
    ...
    const teamDisplayNames: { [key: string]: string } = {
        writing: "Writing",
        design: "Design",
        photography: "Photography",
        web_and_software: "Web & Software",
    };
    ...
    return (
        <Box className="min-h-screen bg-neutral/10">
            ...
            <Box className="mx-auto max-w-6xl px-6 py-8">
                ...
                {Object.entries(teams).map(([teamKey, members]) => (
                    <Box key={teamKey} className="mb-12">
                        <Text style="bold" color="black" className="text-3xl mb-6">
