      ...
      },
      {
        ...
        segments: [
          ...
          },
          {
            type: "text",
            content:
              " produces around 26.1 MWh per day, more than enough to power 783 homes for an entire day.",
          },
        ],
      },
      {
        ...
        segments: [
          ...
          {
            type: "link",
            text: "training of an LLM",
            href: "https://doi.org/10.48550/arXiv.2104.10350",
          },
          {
            type: "text",
            content:
              " such as GPT-3 costs 1,287 MWh, and the daily usage averages around 850 MWh (assuming ",
          },
          {
            type: "link",
        ...
        segments: [
          {
            type: "text",
            content:
              "Tech giants have already released the next generation of chips designed specifically for LLM inference! Google's new ",
          },
          {
            type: "link",
            text: "Ironwood TPU",
        ...
        segments: [
          {
            type: "text",
            content:
              'Dynamic Batching and Caching: Even simple adjustments, such as grouping requests into a single "batch" or caching repeated queries, can provide an 8-28% ',
          },
          {
            type: "link",
            text: "throughput increase",
        ...
        segments: [
          {
            type: "text",
            content:
              "So, if these fixes are all proven and low effort to implement, why aren't they universal? A ",
          },
          {
            type: "link",
