...
import { ArticleWithoutImageProps, articleTemplateVariants, iconContainerVariants } from "./variants";
...
export default function ArticleWithoutImage({
  ...
  return (
    <>
      ...
      <div className={iconContainerVariants({ color: articleIcon.color })} style={{ height: '400px' }}>
        <Icon icon={articleIcon.icon} size="xl" color={articleIcon.color || "black"} />
      </div>
