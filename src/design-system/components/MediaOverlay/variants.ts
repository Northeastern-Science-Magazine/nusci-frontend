...
export const overlayVariants = tv({
  ...
  variants: {
    background: {
      ...
      'gradient-red':
        'bg-gradient-to-t from-red-500/80 via-red-500/40 to-transparent text-white',
      'gradient-aqua':
        'bg-gradient-to-t from-aqua/80 via-aqua/40 to-transparent text-white',
      'gradient-aqua-light':
        'bg-gradient-to-t from-aqua-light/80 via-aqua-light/40 to-transparent text-black',
      'gradient-forest-green':
        'bg-gradient-to-t from-forest-green/80 via-forest-green/40 to-transparent text-white',
      'gradient-sage-green':
        'bg-gradient-to-t from-sage-green/80 via-sage-green/40 to-transparent text-black',
      'gradient-border':
        'bg-gradient-to-t from-border/80 via-border/40 to-transparent text-black',
      'gradient-neutral':
        'bg-gradient-to-t from-neutral/80 via-neutral/40 to-transparent text-black',
      'gradient-purple':
        'bg-gradient-to-t from-purple/80 via-purple/40 to-transparent text-white',
      'gradient-pink':
        'bg-gradient-to-t from-pink/80 via-pink/40 to-transparent text-black',
      'gradient-maroon':
        'bg-gradient-to-t from-maroon/80 via-maroon/40 to-transparent text-white',
      'gradient-coral':
        'bg-gradient-to-t from-coral/80 via-coral/40 to-transparent text-black',
      'gradient-marigold':
        'bg-gradient-to-t from-marigold/80 via-marigold/40 to-transparent text-black',
...
export interface MediaOverlayProps extends VariantProps<
  typeof mediaOverlayVariants
> {
  className?: string;
  onClick?: () => void;
