  ...
  render: (args) => {
    return (
      <div className="grid grid-cols-1 gap-2">
        <PaginationBar color="aqua-light">
          <PaginationItem isActive={true} text="1" />
          <PaginationItem text="2" />
          <Icon icon="ellipsis" />
          <PaginationItem text="10" />
          <PaginationItem isActive={false} text="11" />
        </PaginationBar>
      </div>
    );
  },
...
//           <DropdownItem value="item6">
//             Item 6 With a Really Long Name
//           </DropdownItem>
//         </DropdownInput>
//       </div>
//     );
