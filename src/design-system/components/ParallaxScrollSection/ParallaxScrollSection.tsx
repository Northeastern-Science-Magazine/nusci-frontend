...
export function ParallaxScrollSection({
  ...
  const imageY = useTransform(
    dividerScroll,
    [0, 1],
    parallaxMap[parallaxIntensity || 'medium'],
  );

  return (
    <div
      className={clsx(
        parallaxScrollSectionVariants({ height, parallaxIntensity, offset }),
        className,
      )}
    >
      ...
      <div
        ref={dividerRef}
        className="parallax-container relative w-full overflow-hidden"
      >
        <motion.div
          style={{ y: imageY }}
          className="parallax-image absolute top-[-25%] left-0 w-full h-[150%]"
        >
      ...
      <motion.div
        ...
        className={clsx(
          'newspaper-section relative mx-auto w-full',
          maxWidth,
          padding,
        )}
      >
