...
import {
  OpacityProps,
  opacityVariants,
} from '@/design-system/utilities/props/Opacity/opacity';
import {
  PaddingProps,
  paddingVariants,
...
export const buttonVariants = tv({
  ...
  variants: {
    ...
    color: {
      ...
      border:
        'text-black bg-border border-border hover:bg-border hover:border-border focus:ring-border',
      neutral:
