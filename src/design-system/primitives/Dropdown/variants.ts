...
export const dropdownVariants = tv({
  slots: {
    ...
    optionRow:
      'w-full flex items-center gap-2 px-3 py-2 text-left hover:bg-border rounded-md',
    iconContainer:
...
export interface DropdownProps
  extends
    Omit<DropdownVariants, 'multiSelect' | 'typeahead'>,
    AnimationProps,
    DisplayProps,
    MarginProps,
    PaddingProps,
...
export const dropdownVariantsCN = (
