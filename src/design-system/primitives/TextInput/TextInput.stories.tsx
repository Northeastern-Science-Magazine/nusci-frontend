...
/** Story comparing single-line vs multi-line side by side */
export const Comparison: Story = {
  render: () => {
    return (
      <div className="space-y-8 max-w-4xl">
        <div>
          <h2 className="text-2xl font-bold mb-6">Single-Line Input vs Multi-Line Textarea</h2>
          <div className="grid grid-cols-1 laptop:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h3 className="text-lg font-semibold">Single-Line Input (multiline: false)</h3>
              <TextInput label="Name" placeholder="Enter your name" variant="outline" color="black" size="md" multiline={false} />
              <TextInput
                label="Email"
                placeholder="Enter your email"
                variant="outline"
              ...
              <p className="text-sm text-gray-600 mt-4">
                <strong>Features:</strong> Single line, uses &lt;input&gt; element, supports input types (email, password, etc.),
                no rows or resize props
              </p>
            </div>
            <div className="space-y-4">
              <h3 className="text-lg font-semibold">Multi-Line Textarea (multiline: true)</h3>
              <TextInput
                label="Bio"
                placeholder="Tell us about yourself..."
                variant="outline"
              ...
              />
              <p className="text-sm text-gray-600 mt-4">
                <strong>Features:</strong> Multiple lines, uses &lt;textarea&gt; element, supports rows and resize props, better
                for longer text
              </p>
            </div>
          </div>
